...
import contest.FantasticBits.game.Plan.Command;
import contest.FantasticBits.game.Plan.TARGET;


public class Game {
	
	/** coordinate X of the map **/
	private static final int mapX = 16001;

	/** coordinate Y of the map **/
	private static final int mapY = 750;
	
	

	public static class Point{
		
		/** Initial X position of the entity **/
		private int initialX;

		/** Initial Y position of the entity **/
		private int initialY;


		/** Current X position of the entity **/
		...
		/**
		 * Constructor
		 * @param x int x position value of the entity
		 * @param y int y position value of the entity
		 */
		...
		/**
		 * set the initial as the current position
		 */
		 ...
		 * 
		 * @param p Point that represents the current location of the character
		 */
