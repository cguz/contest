...
import contest.theaccountant.GAManager.STYPE;
import contest.theaccountant.Plan.Command;
import contest.theaccountant.game.Game;
import contest.theaccountant.game.Game.BinarySearchTree;
import contest.theaccountant.game.Game.BinarySearchTreeEnemy;
import contest.theaccountant.game.Game.Data;
import contest.theaccountant.game.Game.Enemy;
import contest.theaccountant.game.Game.Hero;
...
public class GA_MAIN {
	...
	private static void testPlayer() {
        ...
        while (true) {
        	...
        	Plan plan = pop.getFittest();
            Command act = plan.getActionToExecute();
	...
	private static void test() {
        ...
        //System.out.println("Solution:");
        System.out.println(pop.getFittest().getActions().remove(0));
